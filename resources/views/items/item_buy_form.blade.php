...
<div class="container">
    <div class="row">
        <div class="col-8 offset-2 bg-white">
            ...
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="form-control" id="number-form"></div>
                    </div>
                    <div class="form-group mt-3">
                        <label for="expiry-form">有効期限</label>
                        <div class="form-control" id="expiry-form"></div>
                    </div>
                    <div class="form-group mt-3">
                        <label for="cvc-form">セキュリティコード</label>
                        <div class="form-control" id="cvc-form"></div>
                    </div>
                </div>
            ...
            <form id="buy-form" action="{{ route('item.buy', [$item->id]) }}" method="post">
                @csrf
