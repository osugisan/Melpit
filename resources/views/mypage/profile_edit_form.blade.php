    ...
    <div id="profile-edit-form" class="container">
        ...
        <div class="row">
            <div class="col-8 offset-2 bg-white">
                ...
                <div class="font-wight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">プロフィール編集</div>

                <form action="{{ route('mypage.edit-profile') }}" method="post" class="p-5" enctype="multipart/form-data">
                    @csrf
                    ...
                    <span class="avatar-form image-picker">
                        ...
                        <label for="avatar" class="d-inline-block">
                            @if (!empty($user->avatar_file_name))
                                <img src="/storage/avatars/{{$user->avatar_file_name}}" class="shadow-lg rounded-circle" style="object-fit: cover; width: 200px; height: 200px;">
                            @else
